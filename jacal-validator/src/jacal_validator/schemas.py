...
Cache lives at ~/.cache/jacal-validator/schemas/{source_hash}/.
...
_CACHE_ROOT = Path.home() / ".cache" / "jacal-validator" / "schemas"

SCHEMA_FILES: dict[str, str] = {
    "core_structure": "acal-core-json-v1.0-schema.json",
    "core_constraints": "acal-core-yaml-v1.0-constraints.yaml",
    "xpath_structure": "acal-xpath-json-v1.0-schema.json",
    "jsonpath_structure": "acal-jsonpath-json-v1.0-schema.json",
}
